...
//             {[
//               ...new Set(documents.map((item: DocumentData) => item.fileType)),
//             ].map((item: DocumentData) => (
//               <option key={item._id} value={item.fileType}>
//                 {item.fileType}
//               </option>
//             ))}
//           </select>
...
//             filteredDocs.map((items: DocumentData) => (
//               <>
//                 <DocsCard {...items} key={items._id} />
//                 {/* <DocsCardSkeleton /> */}
//               </>
//             ))
//           ) : (
